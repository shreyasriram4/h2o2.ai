...
from src.visualisation.dashboard_viz import reformat_data, topics_line_chart_by_quarter, topics_pie_chart, visualise_all_topics, topics_bar_chart_over_time, extract_num_topics
...
async def page3(q: Q):
    ...
    add_card(q, 'article', ui.markdown_card(
        box='horizontal',
        title='',
        content= f'<div align="center"><h2>Exploring Topics </br></br> There are a total of {total_num_topics} topics </h2></div>'
    ))
