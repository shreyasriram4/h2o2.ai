...
async def page4(q: Q):
    ...
    add_card(q, 'article', ui.markdown_card(
        box='horizontal',
        title='',
        content='<div align="center"><h2>Start exploring specific topic!' +
        '</h2></div>',
    ))
    ...
    add_card(q, 'searchbar2', ui.form_card(
        box='horizontal1',
        items=[
            ui.textbox(name='textbox_placeholder', label='Input topic label:',
                       placeholder="Enter 'Food' if you would like to" +
                       "explore more about this topic"),
            ui.button(name='show_inputs', label='Submit', primary=True), ],
            ),)

    add_card(q, 'notable_reviews',
             ui.tall_info_card(
                box='horizontal2', name='', title='Speed',
